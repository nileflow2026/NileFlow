    ...
    if (i <= roundedRating) {
      ...
      stars.push(
        <FontAwesomeIcon
          key={i}
          icon={faStarRegular}
          className="text-[color:var(--nf-text-muted)] w-2 h-2 xs:w-2.5 xs:h-2.5 sm:w-3 sm:h-3 md:w-3.5 md:h-3.5 lg:w-4 lg:h-4 xl:w-4.5 xl:h-4.5 2xl:w-5 2xl:h-5"
        />,
      );
    }
  }
...
const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      {/* Main Card */}
      <div
        className="relative backdrop-blur-sm rounded-2xl sm:rounded-3xl overflow-hidden transition-all duration-500 group-hover:shadow-2xl h-full"
        style={{
      ...
      >
        ...
        {/* Image Container */}
        <div
          className="relative h-40 xs:h-44 sm:h-48 md:h-56 lg:h-64 xl:h-72 overflow-hidden"
        ...
        >
          ...
          >
            <Link
              to={`/products/${id}`}
              className="w-6 h-6 xs:w-8 xs:h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-11 lg:h-11 rounded-full bg-gradient-to-r from-gray-900/80 to-black/80 backdrop-blur-sm border border-[var(--nf-border-subtle)] flex items-center justify-center text-amber-400 hover:text-[color:var(--nf-accent)] hover:scale-110 transition-all"
            >
        ...
        <div className="p-2 xs:p-3 sm:p-4 md:p-5 lg:p-6">
          <div className="mb-2 xs:mb-3 sm:mb-4">
            {categoryPath && categoryName ? (
              <Link
                to={categoryPath}
                className="text-[10px] xs:text-xs sm:text-sm hover:opacity-75"
            ...
            <Link to={`/products/${id}`}>
              <h3
                className="text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl font-bold transition-colors duration-300 line-clamp-2 min-h-[2rem] xs:min-h-[2.5rem] sm:min-h-[3rem] md:min-h-[3.5rem]"
            ...
            {(product.premiumDeal || product.isPremiumDeal) && (
              <p
                className="text-[10px] xs:text-xs sm:text-sm md:text-base mt-0.5 xs:mt-1 sm:mt-2 line-clamp-2"
          ...
          <div className="flex items-center justify-between mb-2 xs:mb-3 sm:mb-4">
            ...
            <div className="flex items-center space-x-0.5 xs:space-x-1 sm:space-x-1.5 md:space-x-2 lg:space-x-2 xl:space-x-2.5 bg-gradient-to-r from-amber-900/40 to-yellow-900/30 backdrop-blur-sm px-1.5 xs:px-2 sm:px-2.5 md:px-3 lg:px-3.5 xl:px-4 2xl:px-5 py-0.5 xs:py-1 sm:py-1.5 md:py-2 lg:py-2 xl:py-2.5 rounded-full border border-[var(--nf-border-subtle)]">
              ...
              <span
                className="text-[10px] xs:text-xs sm:text-sm md:text-base lg:text-base xl:text-lg 2xl:text-xl font-bold"
                style={{ color: "var(--nf-accent)" }}
              >
          ...
          {(product.premiumDeal || product.isPremiumDeal) && (
            <div className="flex flex-wrap gap-0.5 xs:gap-1 sm:gap-1.5 md:gap-2 mb-3 xs:mb-4 sm:mb-6">
              <div
                className="flex items-center space-x-0.5 xs:space-x-1 backdrop-blur-sm px-1.5 xs:px-2 sm:px-2.5 md:px-3 py-0.5 xs:py-1 sm:py-1.5 rounded-lg"
                style={{
                  background: "var(--nf-bg-subtle)",
                  border: "1px solid var(--nf-border-subtle)",
                }}
              >
                <Shield className="w-1.5 h-1.5 xs:w-2 xs:h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3 text-emerald-500" />
                <span className="text-[10px] xs:text-xs sm:text-sm text-emerald-600 dark:text-emerald-300">
              ...
              >
                <Truck className="w-1.5 h-1.5 xs:w-2 xs:h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3 text-blue-500" />
              ...
              >
                <Sparkles
                  className="w-1.5 h-1.5 xs:w-2 xs:h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3"
                  style={{ color: "var(--nf-accent)" }}
                />
                <span
                  className="text-[10px] xs:text-xs sm:text-sm"
            ...
            <AddToCartButton
              ...
              className={`w-full px-1.5 xs:px-2 sm:px-3 md:px-4 lg:px-5 py-1.5 xs:py-2 sm:py-2.5 md:py-3 rounded-lg xs:rounded-xl text-[11px] xs:text-xs sm:text-sm md:text-base lg:text-lg font-bold transition-all duration-300 flex items-center justify-center space-x-1 xs:space-x-2 group/cart ${
                product.premiumDeal || product.isPremiumDeal
                  ...
                  : "border transition-colors border-[var(--nf-border)] hover:border-[var(--nf-accent)] bg-[var(--nf-btn-secondary-bg)] text-[color:var(--nf-accent)]"
              }`}
            >
              <ShoppingBag
