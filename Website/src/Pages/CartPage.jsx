    ...
    <div className="min-h-screen bg-[var(--nf-bg-primary)] text-[color:var(--nf-text-primary)]">
      ...
      <div className="relative pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-10 md:pb-12 px-3 sm:px-4 md:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-8xl mx-auto text-center">
          <div className="inline-flex items-center space-x-1.5 sm:space-x-2 bg-gradient-to-r from-amber-900/30 to-emerald-900/30 backdrop-blur-sm px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-xl sm:rounded-2xl border border-[var(--nf-border-subtle)] mb-4 sm:mb-5 md:mb-6">
            <ShoppingCart className="w-4 h-4 sm:w-5 sm:h-5 text-amber-400" />
            <span className="text-[color:var(--nf-accent)] font-medium tracking-wide text-xs sm:text-sm">
              Premium Cart
            </span>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-5 md:mb-6 leading-tight">
            ...
            <span className="text-[color:var(--nf-text-primary)] block mt-1 sm:mt-2">
              African Treasures
            </span>
          </h1>

          <p className="text-[color:var(--nf-text-secondary)] text-sm sm:text-base md:text-lg max-w-xl md:max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10 px-2 sm:px-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4 max-w-sm sm:max-w-2xl md:max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-amber-900/20 to-transparent backdrop-blur-sm border border-[var(--nf-border-subtle)] rounded-lg sm:rounded-xl md:rounded-2xl p-2 sm:p-3 md:p-4">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-[color:var(--nf-accent)]">
                {cart.length}
              </div>
        ...
        <div className="relative max-w-8xl mx-auto">
          {cart.length === 0 ? (
            <div className="text-center py-16 sm:py-24 md:py-32">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-[color:var(--nf-text-primary)] mb-3 sm:mb-4">
                Your Cart is Empty
              </h3>
              <p className="text-[color:var(--nf-text-muted)] max-w-sm sm:max-w-md mx-auto mb-6 sm:mb-8 text-sm sm:text-base px-4 sm:px-0">
              ...
              <div className="mt-8 sm:mt-12">
                <h4 className="text-lg sm:text-xl font-bold text-[color:var(--nf-accent)] mb-4 sm:mb-6">
                  Popular Categories
                </h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 max-w-2xl mx-auto">
                  {["Fashion", "Art", "Home", "Jewelry"].map((category) => (
                    <Link
                      ...
                      className="bg-[var(--nf-bg-elevated)] backdrop-blur-sm border border-[var(--nf-border-subtle)] rounded-xl p-3 sm:p-4 text-center hover:border-amber-500/50 transition-all duration-300"
                    >
                      <div className="text-[color:var(--nf-accent)] font-bold text-sm sm:text-base">
                        {category}
                      </div>
                      <div className="text-[color:var(--nf-text-muted)] text-xs sm:text-sm mt-1">
                        Premium {category}
                      </div>
                    </Link>
                  ))}
            ...
            <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="lg:col-span-2 space-y-4 sm:space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-2 sm:gap-0">
                  <h2 className="text-xl sm:text-2xl font-bold text-[color:var(--nf-accent)]">
                    Your Premium Items
                  </h2>
                ...
                {cart.map((item) => (
                  <div
                    ...
                    className="group relative bg-[var(--nf-card-bg)] backdrop-blur-sm border border-[var(--nf-border-subtle)] rounded-2xl sm:rounded-3xl overflow-hidden transition-all duration-500 hover:border-amber-500/50 hover:shadow-2xl hover:shadow-amber-900/30"
                  >
                    {/* Product Card */}
                    <div className="p-4 sm:p-6">
                          ...
                          <div className="flex flex-col h-full">
                            <div className="mb-3 sm:mb-4">
                              <Link
                                to={`/products/${item.id || item.productId}`}
                              >
                                <h3 className="text-lg sm:text-xl font-bold text-[color:var(--nf-text-primary)] group-hover:text-[color:var(--nf-accent)] transition-colors duration-300 line-clamp-2">
                                  {item.productName}
                                </h3>
                              </Link>
                              ...
                              <div className="flex items-center space-x-2 mt-2">
                                ...
                                <div className="text-[color:var(--nf-text-muted)] text-xs sm:text-sm truncate">
                              ...
                              <div className="flex items-center justify-between sm:justify-end space-x-3 sm:space-x-4">
                                ...
                                <div className="flex items-center bg-[var(--nf-bg-elevated)] backdrop-blur-sm border border-[var(--nf-border-subtle)] rounded-lg sm:rounded-xl overflow-hidden">
                                  <button
                                    ...
                                    className="p-2 sm:p-3 text-amber-400 hover:text-[color:var(--nf-accent)] hover:bg-amber-900/30 transition-all duration-300 touch-manipulation"
                                    disabled={item.quantity <= 1}
                                  >
                                    <Minus className="w-3 h-3 sm:w-4 sm:h-4" />
                                  </button>
                                  <span className="px-3 sm:px-4 py-2 sm:py-3 text-base sm:text-lg font-bold text-[color:var(--nf-accent)] min-w-[2.5rem] sm:min-w-[3rem] text-center">
                                    {item.quantity || 1}
                                  </span>
                                  <button
                                    onClick={() =>
                                ...
                                <div className="flex items-center space-x-2">
                                  <button
                                    ...
                                    className="p-2 sm:p-3 border border-[var(--nf-border-subtle)] text-amber-400 rounded-lg sm:rounded-xl hover:border-amber-500/50 hover:bg-amber-900/20 transition-all duration-300 touch-manipulation"
                      ...
                      {/* Features */}
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-[var(--nf-border-subtle)]">
                        <div className="flex items-center space-x-2">
                    ...
                    {/* Total for Item */}
                    <div className="absolute top-3 sm:top-6 right-3 sm:right-6 bg-gradient-to-r from-amber-900/30 to-yellow-900/30 backdrop-blur-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl border border-[var(--nf-border-subtle)]">
                      <div className="text-sm sm:text-lg font-bold text-[color:var(--nf-accent)]">
                ...
                <div className="mt-6 sm:mt-8">
                  <Link
                    to="/shop"
                    className="group inline-flex items-center space-x-2 sm:space-x-3 px-4 sm:px-6 py-2.5 sm:py-3 bg-[var(--nf-bg-elevated)] backdrop-blur-sm border border-[var(--nf-border-subtle)] rounded-xl hover:border-amber-500/50 transition-all duration-300 text-sm sm:text-base"
                  >
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-20 sm:top-24">
                  <div className="bg-[var(--nf-card-bg)] backdrop-blur-sm border border-[var(--nf-border-subtle)] rounded-2xl sm:rounded-3xl overflow-hidden">
                    <div className="p-4 sm:p-6 md:p-8 border-b border-[var(--nf-border-subtle)]">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-3 sm:gap-0">
                        <div className="flex items-center space-x-3">
                          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-600 to-amber-700 flex items-center justify-center">
                            <ShoppingCart className="w-5 h-5 sm:w-6 sm:h-6 text-[color:var(--nf-text-primary)]" />
                          </div>
                          <div>
                            <h2 className="text-xl sm:text-2xl font-bold text-[color:var(--nf-accent)]">
                              Order Summary
                            </h2>
                            <p className="text-[color:var(--nf-text-muted)] text-sm sm:text-base">
                              {cart.length} premium items
                            </p>
                          </div>
                        </div>
                        <div className="bg-gradient-to-r from-amber-900/40 to-yellow-900/30 backdrop-blur-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl border border-[var(--nf-border-subtle)]">
                          <span className="text-[color:var(--nf-accent)] font-bold text-sm sm:text-base">
                            Secure
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6 max-h-60 sm:max-h-96 overflow-y-auto pr-2 sm:pr-4">
                        {cart.map((item) => (
                          <div
                            key={item.id}
                            className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-[var(--nf-bg-elevated)] backdrop-blur-sm border border-[var(--nf-border-subtle)] rounded-xl sm:rounded-2xl"
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <h3 className="font-bold text-[color:var(--nf-text-secondary)] truncate text-sm sm:text-base">
                                {item.productName || item.name}
                              </h3>
                              <p className="text-[color:var(--nf-text-muted)] text-xs sm:text-sm">
                                Qty: {item.quantity}
                              </p>
                            </div>
                            <div className="text-right">
                              <p className="text-lg sm:text-xl font-bold text-[color:var(--nf-accent)]">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div className="flex items-center justify-between py-2 sm:py-3 border-b border-[var(--nf-border-subtle)]">
                          <span className="text-[color:var(--nf-text-secondary)] text-sm sm:text-base">
                            Subtotal
                          </span>
                          <span className="text-[color:var(--nf-accent)] font-bold text-base sm:text-lg">
                            {formattedSubtotal}
                          </span>
                        </div>
                        ...
                        {isPremium &&
                          ...
                          discountInfo.discountAmount > 0 && (
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-2 sm:py-3 border-b border-[var(--nf-border-subtle)] bg-gradient-to-r from-purple-900/10 to-blue-900/10 -mx-4 sm:-mx-6 md:-mx-8 px-4 sm:px-6 md:px-8 rounded-lg gap-2 sm:gap-0">
                              <div className="flex items-center space-x-2">
                        ...
                        {isPremium && subtotal < 500 && (
                          <div className="py-2 sm:py-3 border-b border-[var(--nf-border-subtle)]">
                        ...
                        <div className="flex items-center justify-between py-3 sm:py-4 border-t border-amber-500/30">
                          <span className="text-[color:var(--nf-text-secondary)] text-lg sm:text-xl">
                            Total
                          </span>
                          <span className="text-[color:var(--nf-accent)] font-bold text-2xl sm:text-3xl">
                            {formattedTotal}
                          </span>
                        </div>
                        ...
                        {isPremium &&
                          ...
                          milesInfo.actualMiles > 0 && (
                            <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-gradient-to-r from-amber-900/20 to-orange-900/20 backdrop-blur-sm border border-[var(--nf-border-subtle)] rounded-xl">
                              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                                ...
                                <div className="flex items-center space-x-2">
                                  <span className="text-xl sm:text-2xl font-bold text-[color:var(--nf-accent)]">
                                    {Math.round(milesInfo.actualMiles)}
                                  </span>
                                  <span className="text-[color:var(--nf-accent)] text-sm sm:text-base">
                                    Nile Miles
                                  </span>
                              ...
                              {isPremium && milesInfo.multiplier > 1 && (
                                <p className="text-[color:var(--nf-text-muted)] text-xs sm:text-sm mt-2">
                        ...
                        <div className="mt-4 sm:mt-6 bg-gradient-to-r from-purple-900/20 to-blue-900/20 backdrop-blur-sm border border-purple-500/30 rounded-xl p-3 sm:p-4">
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center flex-shrink-0">
                              <Crown className="w-4 h-4 sm:w-5 sm:h-5 text-[color:var(--nf-text-primary)]" />
                            </div>
                      ...
                      <div className="text-center pt-3 sm:pt-4">
                        <div className="inline-flex flex-col sm:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-2 text-[color:var(--nf-text-muted)] text-xs sm:text-sm">
                    ...
                    {/* Additional Info */}
                    <div className="p-4 sm:p-6 border-t border-[var(--nf-border-subtle)]">
                      <h3 className="text-base sm:text-lg font-bold text-[color:var(--nf-accent)] mb-3 sm:mb-4">
                        Order Benefits
                      </h3>
                      <div className="space-y-2.5 sm:space-y-3">
                        <div className="flex items-center space-x-3">
                          <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-emerald-600 to-emerald-700 flex items-center justify-center flex-shrink-0">
                            <Globe className="w-3 h-3 sm:w-4 sm:h-4 text-[color:var(--nf-text-primary)]" />
                          </div>
                          <div className="min-w-0">
                        ...
                        <div className="flex items-center space-x-3">
                          <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center flex-shrink-0">
                            <Truck className="w-3 h-3 sm:w-4 sm:h-4 text-[color:var(--nf-text-primary)]" />
                          </div>
                          <div className="min-w-0">
                        ...
                        <div className="flex items-center space-x-3">
                          <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-red-600 to-red-700 flex items-center justify-center flex-shrink-0">
                            <RefreshCw className="w-3 h-3 sm:w-4 sm:h-4 text-[color:var(--nf-text-primary)]" />
                          </div>
                          <div className="min-w-0">
